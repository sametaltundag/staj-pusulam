    ...
    <div class="container" style="height: 70px !important;">
        ...
        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasNavbarDark"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasNavbarDarkLabel"><img
                        src="{{ Auth::user()->photo ? asset('images/users/') . '/' . Auth::user()->photo : asset('images/users/user.png') }}"
                        class="mx-2"
                        style="height: 50px;width: 50px;object-fit: cover;object-position: center; border-radius: 50%">{{ Auth::user()->name }} <i class="fas fa-code"></i>
                </h5>
